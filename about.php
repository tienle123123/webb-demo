...
<head>
 ...
 <?php
  session_start();
  $_SESSION['href']="http://localhost/WebFinal/about.php";
  ...
  <main id="main">
    ...
    <section class="about" data-aos="fade-up">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="https://blog.bqe.com/hubfs/BQE%20Blog%20Banner%E2%80%93Number%20of%20Roles%20Architectural%20Firms%20Need-01-1.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>Our clients’ needs are constantly changing, so we continually seek new and better ways to serve them. </h3>
            <p class="fst-italic">
              To do this, we are bringing new talent into the firm, acquiring new companies, and developing new capabilities, for example, in design.
            ...
            <ul>
              <li><i class="bi bi-check2-circle"></i> Our website will help you guys explore all over the world </li>
              <li><i class="bi bi-check2-circle"></i> Can company with you is our pleasure </li>
              <li><i class="bi bi-check2-circle"></i> Scroll to understand more about us </li>
            </ul>
            <p>
              Our value proposition includes centrally managed global policies with local policies arranged in foreign jurisdictions for subsidiaries or portfolio companies. So.. let's try!
            </p>
          </div>
        </div>
...
<script src="assets/js/scrollabout.js"></script>
</body>
